...
4. If you are creating a new role, please add a test for it in our [testing directory.](https://github.com/redhat-cop/infra.satellite_configuration/tree/devel/tests/) by adding a new role entry and adding the appropriate yaml file with test data in the `satellite_output` directory.
