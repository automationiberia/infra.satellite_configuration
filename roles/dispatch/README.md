...
| `satellite_configuration_dispatch_content_views_purge_count` | `6` | no | int | Keep this many newest versions per content view after publish; passed to `redhat.satellite.content_view_version_cleanup`. Alias: `content_views_purge_count`. |
